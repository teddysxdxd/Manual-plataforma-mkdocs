---
title: Datos Negocio - PEP Cónyugue 
hide:
  - toc
  - nav
---
# Datos Negocio – PEP Cónyuge

Registro de los negocios informales que posee el cónyuge de la persona PEP. El registro de negocios es opcional. 

Para agregar un negocio se debe incluir los datos indicados como obligatorios.
...
![Datos de Negocio 1](../assets/images/datos_de_negocio_1.png)

![Datos de Negocio 2](../assets/images/datos_de_negocio_2.png)

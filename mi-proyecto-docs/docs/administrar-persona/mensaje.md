...
Muestra los mensajes relacionados a la persona (Natural o Jurídica). Estos mensajes pueden ser solo informativos y algunos pueden requerir una acción específica.

En esta sección se visualizan mensajes que permiten identificar personas que se encuentran en:
* **Lista de cautela.**
* **Personas Expuestas Políticamente (PEP).**

![Administrar Mensajes](../assets/images/aministrar_mensaje.png)

...
Permite realizar la consulta y edición de los datos de los miembros de la junta directiva registrados a una persona (Jurídica). 

En esta sección se habilitan las opciones para gestionar los registros existentes o agregar nuevos miembros. Para guardar cualquier cambio realizado, el sistema solicitará las credenciales que autorizan la modificación de los datos del cliente.
...
![Gestión de Junta Directiva](../assets/images/administrar_jd.png)

...
Esta sección permite redireccionar al usuario al directorio donde se encuentran consolidados todos los formularios que deben ser impresos con la información actualizada del cliente.

![Directorio de Impresión](../assets/images/administrar_impresion.png)
